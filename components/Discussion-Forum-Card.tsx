...
const DiscussionForumCard = ({
  ...
  return (
    <div className="flex flex-col w-[100vw] sm:w-full sm:flex sm:flex-row justify-cneter items-center shadow-md shadow-gray-400 px-4 py-2 gap-4 border">
      ...
      <div className="pl-3 flex flex-col justify-center gap-2">
        <div className="flex gap-4">
          <p className="text-sm sm:text-md font-[500]">
            {firstName} {lastName}
          </p>
        ...
        <p className="w-full text-sm leading-[1.5] sm:w-[85%]">{description}</p>
        <div className=" text-[.8rem] sm:text-md flex gap-4 w-full justify-between select-none">
